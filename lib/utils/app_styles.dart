...
Color primary = const Color(0xFF6787daf);
...
class Styles {
  ...
  static TextStyle headLineStyle3 = const TextStyle(fontSize: 17, color:  Color.fromARGB(255, 31, 27, 27), fontWeight: FontWeight.w500);
  static TextStyle headLineStyle4 = const TextStyle(fontSize: 14, color: Color.fromARGB(255, 31, 27, 27), fontWeight: FontWeight.w500);
}
